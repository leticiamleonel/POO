...
import com.POO.gestaoDisk.modelo.entidades.PERFIL;
...
public class UsuarioController implements ActionListener, MouseListener, KeyListener{
    ...
    private void inicializaComboBoxUsuarioPerfil() {
        ...
        this.dashboard.getComboBoxUsuarioPerfil().addItem("Selecionar o perfil");
    ...
    private void editar() {
        ...
        if(autenticacaoDao.temPermissao(usuarioLogado)) {
            if(this.usuario != null) {
                ...
                JOptionPane.showMessageDialog(dashboard, "Deve selecionar um usuario na tabela", "Selecionar um usuario", 0);
            }
        }
