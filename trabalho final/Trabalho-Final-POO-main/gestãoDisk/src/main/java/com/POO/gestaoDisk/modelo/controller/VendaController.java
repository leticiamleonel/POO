...
import com.POO.gestaoDisk.modelo.util.AbstractMouseListener;
import com.POO.gestaoDisk.modelo.dao.CategoriaDao;
import com.POO.gestaoDisk.modelo.dao.ClienteDao;
import com.POO.gestaoDisk.modelo.dao.ProdutoDao;
import com.POO.gestaoDisk.modelo.dao.UsuarioDao;
import com.POO.gestaoDisk.modelo.dao.VendaDao;
import com.POO.gestaoDisk.modelo.entidades.Cliente;
import com.POO.gestaoDisk.modelo.entidades.Produto;
import com.POO.gestaoDisk.modelo.entidades.Usuario;
import com.POO.gestaoDisk.modelo.entidades.Venda;
import com.POO.gestaoDisk.modelo.entidades.VendaDetalhes;
import com.POO.gestaoDisk.modelo.exception.NegocioException;
import com.POO.gestaoDisk.modelo.util.VendaRegistroTableModel;
import com.POO.gestaoDisk.modelo.util.VendaTableModel;
...
public class VendaController extends AbstractMouseListener implements ActionListener, KeyListener {
    ...
    private void validacaoDaQuantidade(Integer quantidade) {
        if(quantidade <= 0) {
            String mensagem = String.format("Quantidade nao pode ser um numero negativo");
            mensagemNaTela(mensagem, Color.RED);
            throw new NegocioException(mensagem);
        }
    }
